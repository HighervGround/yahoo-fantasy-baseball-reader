...
- For each proposal, use exactly this template:
  ...
  - **Draft context (optional):** If \`draft_analysis\` exists for a player, you may add one short clause (e.g. "Yahoo avg pick ~45") — clarify it is **not** their pick in this league unless you have no such data.
